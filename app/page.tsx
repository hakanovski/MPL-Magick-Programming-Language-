    ...
    <div className="flex h-screen bg-[#050505] text-[#e0e0e0] font-mono overflow-hidden selection:bg-[#00f2ff] selection:text-black">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-12 gap-6 p-6 geometric-grid relative z-40">
          ...
          {/* Left Column: Editor */}
          <section className="col-span-12 lg:col-span-7 border-arcane terminal-blur flex flex-col rounded-xl overflow-hidden">
            <div className="h-10 border-b border-[#222] bg-[#050505]/50 flex items-center justify-between px-4">
          ...
          <section className="col-span-12 lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex-1 border-arcane terminal-blur p-4 flex flex-col rounded-xl">
            ...
            <div className="flex-1 border-arcane terminal-blur p-4 flex flex-col font-mono rounded-xl">
              ...
              <div className="flex-1 overflow-y-auto space-y-1 bg-black p-3 border border-dashed border-[#444] text-[9px] text-blue-300">
